// questo è il file di configurazione di karma (=test runner) che fornisce istruzioni a karma su: quale framework per i
// test utilizzare (Jasmine), quali sono i plugin richiesti per i test, quali file includere per i test e quali escludere ecc...
